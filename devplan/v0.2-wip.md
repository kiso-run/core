...
- [ ] `kiso/worker/search.py`: nuovo modulo con `_search_task()` estratto da `loop.py`
- [ ] `kiso/worker/loop.py`: rimuovere il search handler inline, importare da `search.py`
- [ ] `kiso/worker/__init__.py`: esportare le funzioni search
- [ ] verificare che tutti i test passino invariati
