...
### Test / copertura
- **M80**: integration test per `cli/__init__.py` — test end-to-end che chiama `main(["user", "list"])` con config mock e verifica exit code + output senza dover patchare ogni singola funzione interna
