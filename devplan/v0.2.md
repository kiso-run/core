...
- **M81**: controlla coverage di `kiso instance *` (sub-comandi istanza) — verificare che i comandi in `cli/instance.py` abbiano lo stesso livello di copertura di `cli/user.py`
