...
- Kiso CLI: short wrapper/connector names only (e.g., `kiso wrapper install browser`). Never prefix `kiso-wrapper-`.
...
- Wrapper binaries: system prepends wrapper venv PATH automatically — no manual PATH= needed.
